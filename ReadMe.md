...
gives access to the route match object (which allows routes to match with the corresponding url).

2. How would you explain form validation to someone who has never programmed before?

checking to make sure information entered is valid, like checking to make sure where someone should put email they put an email
